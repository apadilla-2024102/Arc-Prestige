...
public class CloudinaryService(IConfiguration configuration) : ICloudinaryService
{
    ...
    {
        var defaultPath = configuration["clodinarySettings:DefaultAvatarPath"] ?? "Archery_apmdjz.png";
    ...
    {
        var baseUrl = configuration["clodinarySettings:BaseURL"] ?? "https://res.cloudinary.com/dbjg9o5oj/image/upload/v1773027240";
        var folder = configuration["clodinarySettings:Folder"] ?? "ArcPrestige/profiles";
        var defaultPath = configuration["clodinarySettings:DefaultAvatarPath"] ?? "Archery_apmdjz.png";
